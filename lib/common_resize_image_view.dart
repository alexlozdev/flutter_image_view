...
class CommonResizeImageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return getClipRect(
      child: imageProvider != null ? Image(image: ResizeImage(imageProvider!, width: 300)) : errorWidget,
    );
  }
